...
function reloadArtist(name) {
	...
	deleteBtn.setAttribute("onclick", "searchArtists()");
	deleteBtn.setAttribute("value", "Delete");
	deleteBtn.setAttribute("class", "delete-btn");
	deleteBtn.setAttribute("id", "delete-"+artist[0]);
...
function addArtist() {
	...
	deleteBtn.setAttribute("value", "Delete");
	deleteBtn.setAttribute("class", "delete-btn");
	deleteBtn.setAttribute("id", "delete-"+namebox);

	listinfo.appendChild(listname);
	listinfo.appendChild(listdesc);
	listinfo.appendChild(deleteBtn);
	listimgdiv.appendChild(listimg);
